...
export const zh: MessageCatalog = {
  ...
  'story.s1.hulaoguan.title': '虎牢关前',
  'story.s1.hulaoguan.body':
    '义盟大军受阻于虎牢关下。天下第一猛将吕布跨赤兔、挺方天画戟出关搦战，连斩数将，诸侯无人敢当，联军阵脚为之动摇。你按不住心头热血，唤关羽、张飞并马而出——桃园三兄弟，共战那不败之人。稳住心神：正是在这方战场上，天下第一次记住你们的名姓。',
  'story.s1.hulaoguan.win.title': '力退吕布',
  'story.s1.hulaoguan.win.body':
    '三般兵器如一体般翻飞，纵是吕布也难以支撑，终于拨转赤兔，败退回关。联军趁势掩杀，喊声震野；万军齐呼涿郡三兄弟之名，你的威名自此响彻四海。此后无论际遇如何，天下已然记住了刘备、关羽、张飞。',
  'story.s1.hulaoguan.lose.title': '关前受挫',
  'story.s1.hulaoguan.lose.body':
    '吕布画戟如狂风骤雨，三人皆难抵挡，带伤败退回本阵。所幸关、张拼死将你救回，而联军攻势并未因此稍歇——一场单挑之败，动摇不了讨逆大计。你裹好伤口，于旌旗之间重整旗鼓，再度将目光投向前路。这一章的功业，远未完结。',
